...
AcceptData <- R6Class(
    ...
    public = list(
        ...
        smoker = object("BooleanInput"),
        oxygen = object("BooleanInput"),
        statin = object("BooleanInput"),
        LAMA = object("BooleanInput"),
        LABA = object("BooleanInput"),
        ICS = object("BooleanInput"),
        azithromycin = object("BooleanInput"),
